 ...
 */
final readonly class SentinelConfigPolicyMergeStrategy
{
    /**
     ...
     */
    public function mergeReviewConfig(array $policy, ReviewConfig $reviewConfig): array
    {
     ...
     * @return array<string, mixed>
     */
    public function mergePathsConfig(array $policy, PathsConfig $pathsConfig): array
    {
     ...
     * @return array<string, mixed>
     */
    public function mergeAnnotationsConfig(array $policy, AnnotationsConfig $annotationsConfig): array
    {
        $policy['annotations'] = [
     ...
     * @return array<string, mixed>
     */
    public function mergeProviderConfig(array $policy, ProviderConfig $providerConfig): array
    {
        $policy['provider'] = [
