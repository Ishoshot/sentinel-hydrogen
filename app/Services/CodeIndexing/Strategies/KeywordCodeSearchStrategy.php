...
{
    /**
     * Create a new KeywordCodeSearchStrategy instance.
     */
    public function __construct(
        private KeywordSearchScoringStrategy $scoringStrategy,
    ) {}
    ...
    public function execute(Repository $repository, string $query, int $limit, ?array $fileTypes): array
    {
        ...
        return $results
            ->map(fn (CodeIndex $index): array => [
                ...
                'content' => $this->scoringStrategy->extractSnippet($index->content, $searchTerms),
                'score' => $this->scoringStrategy->calculateScore($index, $searchTerms),
                'metadata' => [
