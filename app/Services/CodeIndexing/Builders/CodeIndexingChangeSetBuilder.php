 ...
 */
final readonly class CodeIndexingChangeSetBuilder
{
    /**
    ...
    public function plan(array $changedFiles): array
    {
        ...
        $indexableFiles = $this->changeSetBuilder->prepare($added, $modified);
        ...
        return [
            ...
            'requires_full_reindex' => $this->changeSetBuilder->exceedsThreshold($indexableFiles),
        ];
    }
}
