 ...
 */
final readonly class GetRepositoryActivity
{
    /**
     * Get repository activity for a workspace.
     *
     * @return Collection<int, array{repository_id: int, repository_name: string, runs_count: int, findings_count: int, last_run_at: string|null}>
     */
