...
Files matching `sensitive` patterns are flagged as security-sensitive in the review context:

-   The AI is explicitly informed these files require extra scrutiny
-   Security-focused analysis is prioritized for these files
-   Authentication/authorization patterns are highlighted
-   Data handling is examined more carefully
-   Findings in these files may be elevated in priority
...
| `testing`         | `false` | Test coverage, test quality, missing tests          |
