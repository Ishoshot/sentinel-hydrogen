...
it('allows owners to view any provider keys', function (): void {
    $user = User::factory()->create();
    $workspace = Workspace::factory()->create();
...
it('allows admins to view any provider keys', function (): void {
    $user = User::factory()->create();
    $workspace = Workspace::factory()->create();
...
it('allows viewing a workspace-level provider key for workspace members', function (): void {
    $user = User::factory()->create();
    $workspace = Workspace::factory()->create();
    TeamMember::factory()->forUser($user)->forWorkspace($workspace)->create();
...
it('allows owners to create provider keys', function (): void {
    $user = User::factory()->create();
    $workspace = Workspace::factory()->create();
    TeamMember::factory()->forUser($user)->forWorkspace($workspace)->owner()->create();
    $connection = Connection::factory()->forProvider($this->provider)->forWorkspace($workspace)->create();
...
it('denies non-members from creating provider keys', function (): void {
    $user = User::factory()->create();
    $workspace = Workspace::factory()->create();
    $connection = Connection::factory()->forProvider($this->provider)->forWorkspace($workspace)->create();
    $installation = Installation::factory()->forConnection($connection)->create();
...
it('allows admins to update provider keys', function (): void {
    $user = User::factory()->create();
    $workspace = Workspace::factory()->create();
    TeamMember::factory()->forUser($user)->forWorkspace($workspace)->admin()->create();
    $connection = Connection::factory()->forProvider($this->provider)->forWorkspace($workspace)->create();
    ...
    expect($this->policy->update($user, $providerKey))->toBeTrue();
});

it('allows owners to update provider keys', function (): void {
    $user = User::factory()->create();
    $workspace = Workspace::factory()->create();
    TeamMember::factory()->forUser($user)->forWorkspace($workspace)->owner()->create();
    $connection = Connection::factory()->forProvider($this->provider)->forWorkspace($workspace)->create();
...
it('denies members from updating provider keys', function (): void {
    $user = User::factory()->create();
    $workspace = Workspace::factory()->create();
    TeamMember::factory()->forUser($user)->forWorkspace($workspace)->member()->create();
    $connection = Connection::factory()->forProvider($this->provider)->forWorkspace($workspace)->create();
    ...
    expect($this->policy->update($user, $providerKey))->toBeFalse();
});

it('denies non-members from updating provider keys', function (): void {
    $user = User::factory()->create();
    $workspace = Workspace::factory()->create();
    $connection = Connection::factory()->forProvider($this->provider)->forWorkspace($workspace)->create();
    $installation = Installation::factory()->forConnection($connection)->create();
...
it('allows owners to delete provider keys', function (): void {
    $user = User::factory()->create();
    $workspace = Workspace::factory()->create();
    TeamMember::factory()->forUser($user)->forWorkspace($workspace)->owner()->create();
    $connection = Connection::factory()->forProvider($this->provider)->forWorkspace($workspace)->create();
...
it('denies non-members from deleting provider keys', function (): void {
    $user = User::factory()->create();
    $workspace = Workspace::factory()->create();
    $connection = Connection::factory()->forProvider($this->provider)->forWorkspace($workspace)->create();
    $installation = Installation::factory()->forConnection($connection)->create();
