...
> **Terminal title.** Update the iTerm title whenever the session topic changes using OSC sequences; use ⚡︎ for Codex. Run: `printf '3]0;%s<laravel-boost-guidelines>
=== .ai/sentinel-context rules ===
...
</laravel-boost-guidelines>7' "⚡︎ Topic" > "$CODEX_TTY"` where "Topic" is a short (2-4 word) description of the current task.
